            ...
            <table class="admin-table">
              ...
              <tbody>
                <tr v-for="user in users" :key="user.Id">
                  ...
                  <td>
                    <button class="icon-btn delete" @click="deleteUser(user.Id)" :disabled="user.Role === 'admin'">
                      🗑️
                    </button>
                  </td>
                </tr>
            ...
            <table class="admin-table">
              ...
              <tbody>
                ...
                <tr v-if="components.length === 0">
                  <td colspan="6" class="empty">Компоненты не найдены</td>
                </tr>
              </tbody>
            </table>
          </div>
